...
const EnterMarks = ({ MarksTable }) => {
    ...
    <div className="home">
      ...
      <div className="pageBodyResult">
        ...
        <Form>
          ...
          <Form.Row>
      <Form.Group className="market-row-first-form" controlId="exampleForm.SelectCustomSizeSm">
  ...
  <Form.Group className="market-row-second-form" controlId="exampleForm.SelectCustomSizeSm">
    <Form.Label>Total Marks of practical <br /> Viva / if amy/</Form.Label>
    <Form.Control as="select" size="sm" >
      <option></option>
      <option>2</option>
      <option>3</option>
